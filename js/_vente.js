  $(document).ready(function() {
      ...
      function add_product_row(count = "") {
          ...
          if (count == '') {
              html +=
                  '<button type="button"  name="add_more" id="add_more" class="btn btn-success btn-xs"><i class="fas fa-plus"></i></button>';
          } else {
              html +=
                  '<button type="button" name="remove" id="' +
                  count +
                  '" class="btn btn-danger btn-xs remove"><i class="fas fa-minus"></i></button>';
          }
          html += "</div>";
